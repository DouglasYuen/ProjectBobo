...
#		self.populateModel(self.theDataStructure, testData) # for testing
		...
		self.printButton.clicked.connect(self.genFinalList)
...
# -------------------------------------------------------------------------------------------
#Agree Button Results in Priting - Also acts as the File Writer
# -------------------------------------------------------------------------------------------
	def genFinalList(self):
		...
		HandoverFile.write("Patient From:____" + '\n')
		...
		HandoverFile.write("Patient is to be followed up by the following MD's:"+'\n')
		for i in range(3):
			HandoverFile.write('\t'+"Dr._________: Patient will book or MD's office will call"+'\n')
		HandoverFile.write("Patient has appointments with the following Allied Health Professionals:"+'\n')
		for i in range(2):
			HandoverFile.write('\t'+"____________: Patient will book or office will call"+'\n')
		HandoverFile.write("Mobility & Function Agreed by PT + OT:___"+'\n')
	
		HandoverFile.write("Discharge Instructions given by: MD____ and/or LPH/RN____"+'\n')
		HandoverFile.write("Discharge MAR Completed By:___"+'\n')
		HandoverFile.write("Discharge Summary Dicated By:__"+'\n')
		HandoverFile.write("Discharge Summary Dicatation Number:"+'\n')
